  ...
  plugins: [
    {
      ...
      config: {
        ...
        devContentSecurityPolicy: `default-src 'self' 'unsafe-inline' data: https://api.vmlogin.com https://api.gologin.com; script-src 'self' 'unsafe-inline' data: https://api.vmlogin.com https://api.gologin.com `,
        // Ports
        port: 8000, // Webpack Dev Server port
